...
function generateImage(dishName, diet, otherConsiderations) {
  return `A lifelike food photo of ${dishName}, ${diet}, ${otherConsiderations}, fancy plating, centered, blurred background, indoor lighting. (Taken on a Sony camera)[food photography, realistic]`
}

...
function generateImage(dishName, diet, otherConsiderations) {
  return `A lifelike food photo of ${dishName}, ${diet}, ${otherConsiderations}, plated fancy on a chef table, centered, blurred background of ingredients, realistic indoor lighting. (Taken on a Sony camera, wide angle lens, 45 degree angle)[restaraunt marketing photo, realistic]`
}

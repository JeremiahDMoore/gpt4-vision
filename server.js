...
function generateImage(dishName, diet, otherConsiderations) {
  return `A lifelike food photo of ${dishName}, ${diet}, ${otherConsiderations}, plated fancy on a chef table, centered in frame, focused on dish, blurred background of ingredients, realistic indoor lighting. (Taken on a Sony camera)[food photography, realistic]`
}

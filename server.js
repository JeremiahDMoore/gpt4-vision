...
function generateImage(dishName, diet, otherConsiderations) {
  return `A lifelike food photo of ${dishName}, ${diet}, ${otherConsiderations}, plated fancy on a chef table, centered, blurred background, realistic indoor lighting. (Taken on a Sony camera)[menu photo, realistic]`
}
